...
static int
memb_service_user_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_service_provider_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_TYPE_member_t asn_MBR_Associate_source_diagnostic_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Associate_source_diagnostic, choice.service_user),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_service_user_constraint_1,
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"service-user"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Associate_source_diagnostic, choice.service_provider),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_service_provider_constraint_1,
		0,	/* PER is not compiled, use -gen-PER */
		0,
		"service-provider"
		},
...
static const asn_TYPE_tag2member_t asn_MAP_Associate_source_diagnostic_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 0, 0, 0 }, /* service-user */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 1, 0, 0 } /* service-provider */
};
