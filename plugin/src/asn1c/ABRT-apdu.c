...
static asn_TYPE_member_t asn_MBR_ABRT_apdu_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct ABRT_apdu, abort_diagnostic),
	...
	{ ATF_POINTER, 3, offsetof(struct ABRT_apdu, aso_qualifier),
	...
	{ ATF_POINTER, 2, offsetof(struct ABRT_apdu, asoi_identifier),
...
static const ber_tlv_tag_t asn_DEF_ABRT_apdu_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ABRT_apdu_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* abort-source */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* abort-diagnostic */
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 2, 0, 0 }, /* aso-qualifier */
    { (ASN_TAG_CLASS_CONTEXT | (14 << 2)), 3, 0, 0 }, /* asoi-identifier */
