...
static int
memb_simple_ASN1_type_constraint_4(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_TYPE_member_t asn_MBR_presentation_data_values_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PDV_list__presentation_data_values, choice.simple_ASN1_type),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_ANY,
		memb_simple_ASN1_type_constraint_4,
...
static const asn_TYPE_tag2member_t asn_MAP_presentation_data_values_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* simple-ASN1-type */
...
static const asn_TYPE_tag2member_t asn_MAP_PDV_list_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 2, 0, 0 }, /* simple-ASN1-type */
