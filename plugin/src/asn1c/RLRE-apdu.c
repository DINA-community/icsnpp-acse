...
static asn_TYPE_member_t asn_MBR_RLRE_apdu_1[] = {
	{ ATF_POINTER, 4, offsetof(struct RLRE_apdu, reason),
	...
	{ ATF_POINTER, 3, offsetof(struct RLRE_apdu, aso_qualifier),
	...
	{ ATF_POINTER, 2, offsetof(struct RLRE_apdu, asoi_identifier),
