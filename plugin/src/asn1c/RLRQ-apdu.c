...
static asn_TYPE_member_t asn_MBR_RLRQ_apdu_1[] = {
	{ ATF_POINTER, 4, offsetof(struct RLRQ_apdu, reason),
	...
	{ ATF_POINTER, 3, offsetof(struct RLRQ_apdu, aso_qualifier),
	...
	{ ATF_POINTER, 2, offsetof(struct RLRQ_apdu, asoi_identifier),
...
static const asn_TYPE_tag2member_t asn_MAP_RLRQ_apdu_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 1, 0, 0 }, /* aso-qualifier */
    { (ASN_TAG_CLASS_CONTEXT | (14 << 2)), 2, 0, 0 }, /* asoi-identifier */
    { (ASN_TAG_CLASS_CONTEXT | (30 << 2)), 3, 0, 0 } /* user-information */
};
